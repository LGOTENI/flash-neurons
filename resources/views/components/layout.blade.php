...
<body>
    <header x-data="{
        navbarOpen: false,
    }" class=" left-0 top-0 z-50 w-full shadow-sm ">
        <div class="container mx-auto ">
            <div class="relative -mx-4 flex items-center justify-between">
                <div class="w-60 max-w-full px-4">
                    <a href="javascript:void(0)" class="w-full py-5 flex justify-center items-center relative">
                        <span class="font-bold text-primary text-4xl">Neuron</span>
                        <div class="font-bold text-primary text-2xl mt-4 px-2 absolute bottom-0 -right-9 ">Fla<span class="text-6xl text-warning">S</span>h</div>
                    </a>
                </div>
                <div class="flex w-full items-center justify-between px-4">
                    ...
                    <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
                        ...
                        <a href="javascript:void(0)"
                            class="rounded-lg bg-primary py-3 px-2 text-base font-medium text-white hover:bg-opacity-90 text-sm">
                            Creer un compte
                        </a>
                    </div>
                </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                    <div class="mb-2 w-full">
                        <a href="javascript:void(0)" class="w-full flex justify-center items-center relative mb-6 inline-block max-w-[160px]"">
                            <span class="font-bold text-primary text-4xl">Neuron</span>
                            <div class="font-bold text-primary text-2xl mt-4 px-2 absolute -bottom-5 -right-11 ">Fla<span class="text-6xl text-warning">S</span>h</div>
                        </a>
